...
export const getdata = (req) => {
  ...
  let server_url = "http://43.205.77.129";

  let urltoken =
    "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..Wf0ZeVwi0WYL4i1ig1ToPHDzG11yz-uBhUZVF-oUmTmEYomf6MaewHdRzdhu22qAhHBmj85G-M39ceqMbC5JQVrqMgY9B7H9sC73AYiUZXjHJgyYFH7oRk9UyI7iz3WkE09Kp6nvaNoMkobeFUe3KbKpyq_b4YcIJZ09LcunLZRedrw3GLa53F6QB4CO0GaHBdcXilQIoelH-IzRl5H3B5do-iPs257cjf96RAWXE-P0NbAMwKwpi2X7gwDbRBBstdkXVwLAYQ5o6auuqo-O1yfShAMCeHYfD5YCmSVjuwnXY4hLEWDgzs3DrrCjgOP6GbdJSKKVz_VE-PZ1ZFa1iA";
  let urlgraphql = server_url + ":7070/graphql";
  var identifier_type = "",
    identifier_id = "";

  if (
    requestBody.identifier_type != null &&
    requestBody.identifier_type != ""
  ) {
  ...
  if (
    ...
    return new Promise((resolve, reject) => {
      ...
      axios(config_url).then(async (response) => {
        ...
        for (let index = 0; index < response.data.entry.length; ++index) {
          var ConstURL =
            server_url +
            ":5001/fhir/Composition?entry=Patient/" +
            response.data.entry[index].resource.id;
          var DataFor = await getDetailDataWithoutData(
            "get",
            ConstURL,
            urltoken
          );
          ...
          if (
            ...
            DataFor != [] &&
            DataFor.entry != null &&
            DataFor.entry != undefined &&
            DataFor.entry != []
          ) {
            for (let indexE = 0; indexE < DataFor.entry.length; ++indexE) {
              response.data.entry[index].detailData = await getDetailData(
                urlgraphql,
                urltoken,
                DataFor.entry[indexE].resource.id
              );
              dataResult.push(response.data.entry[index]);
              console.log(
                "DataFor.data.entry[indexE].resource.id : " +
                  response.data.entry[index]
              );
            }
          }
    ...
    var name = "",
      ...
      lastname = "";
    if (
      requestBody.first_name_value != null &&
      requestBody.first_name_value != ""
    ) {
      name = requestBody.first_name_value;
      firstname = requestBody.first_name_value;
    }
    if (
      requestBody.last_name_value != null &&
      requestBody.last_name_value != ""
    ) {
      if (name) {
        name = name + " ";
      }
    ...
    if (
      requestBody.father_name_value != null &&
      requestBody.father_name_value != ""
    ) {
      if (name) {
        name = name + " ";
      }
    ...
    if (
      requestBody.mother_name_value != null &&
      requestBody.mother_name_value != ""
    ) {
      if (name) {
        name = name + " ";
      }
    ...
    let data = {
      ...
      query:
        "query searchEvents($sort: String, $trackingId: String, $contactNumber: String, $registrationNumber: String, $name: String, $locationIds: [String!]) {\n  searchEvents(\n    sort: $sort\n    trackingId: $trackingId\n    registrationNumber: $registrationNumber\n    name: $name\n    contactNumber: $contactNumber\n    locationIds: $locationIds\n  ) {\n    totalItems\n    results {\n      id\n      type\n      registration {\n        status\n        contactNumber\n        trackingId\n        registrationNumber\n        registeredLocationId\n        duplicates\n        assignment {\n          userId\n          firstName\n          lastName\n          officeName\n          __typename\n        }\n        createdAt\n        modifiedAt\n        __typename\n      }\n      ... on BirthEventSearchSet {\n        dateOfBirth\n        childName {\n          firstNames\n          familyName\n          use\n          __typename\n        }\n        __typename\n      }\n      ... on DeathEventSearchSet {\n        dateOfDeath\n        deceasedName {\n          firstNames\n          familyName\n          use\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n",
    };
    ...
    return new Promise((resolve, reject) => {
      ...
      axios(config_url).then(async (response) => {
        ...
        for (
          let index = 0;
          index < response.data.data.searchEvents.results.length;
          ++index
        ) {
          response.data.data.searchEvents.results[index].detailData =
            await getDetailData(
              urlgraphql,
              urltoken,
              response.data.data.searchEvents.results[index].id
            );
        }
        for (
          let index = 0;
          ...
          var fatherNameReturn = "",
            monthernameReturn = "";
          console.log("asd" + element.detailData);
          if (
            element.detailData != null &&
            element.detailData != undefined &&
            element.detailData.father != null &&
            element.detailData.father != undefined &&
            element.detailData.father.name[0] != null &&
            element.detailData.father.name[0] != undefined
          ) {
          ...
          if (
            element.detailData != null &&
            element.detailData != undefined &&
            element.detailData.mother != null &&
            element.detailData.mother != undefined &&
            element.detailData.mother.name[0] != null &&
            element.detailData.mother.name[0] != undefined
          ) {
          ...
          if (element.type == "Death") {
            if (firstname != null && firstname != "") {
              if (
                ...
                element.deceasedName[0].firstNames.toLowerCase()
              ) {
                thisRecordShouldCount++;
              }
            }
            ...
            if (lastname != null && lastname != "") {
              if (
                ...
                element.deceasedName[0].familyName.toLowerCase()
              ) {
                thisRecordShouldCount++;
              }
            }
            ...
            var ConstURL =
              server_url +
              ":5001/fhir/Patient?identifier=" +
              element.registration.registrationNumber;

            response.data.data.searchEvents.results[index].birthIdentifier =
              await getDetailDataWithoutData("get", ConstURL, urltoken);

            if (firstname != null && firstname != "") {
              if (
                firstname.toLowerCase() !=
                element.childName[0].firstNames.toLowerCase()
              ) {
                thisRecordShouldCount++;
              }
            }
            ...
            if (lastname != null && lastname != "") {
              if (
                lastname.toLowerCase() !=
                element.childName[0].familyName.toLowerCase()
              ) {
                thisRecordShouldCount++;
              }
            }
...
function getDetailData(url, urltoken, IdForFeatch) {
  ...
  return new Promise((resolve, reject) => {
    ...
    axios(config_url).then((response) => {
      console.log("response.data.data.fetchDeathRegistration "+JSON.stringify(response.data))
     
      console.log("response.data.data.fetchDeathRegistration "+response.data.data.fetchDeathRegistration)
...
export const getdatamediator = (req) => {
  ...
  let url = "http://13.126.75.156:5001/searchevent";
  let urltoken =
    "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..Wf0ZeVwi0WYL4i1ig1ToPHDzG11yz-uBhUZVF-oUmTmEYomf6MaewHdRzdhu22qAhHBmj85G-M39ceqMbC5JQVrqMgY9B7H9sC73AYiUZXjHJgyYFH7oRk9UyI7iz3WkE09Kp6nvaNoMkobeFUe3KbKpyq_b4YcIJZ09LcunLZRedrw3GLa53F6QB4CO0GaHBdcXilQIoelH-IzRl5H3B5do-iPs257cjf96RAWXE-P0NbAMwKwpi2X7gwDbRBBstdkXVwLAYQ5o6auuqo-O1yfShAMCeHYfD5YCmSVjuwnXY4hLEWDgzs3DrrCjgOP6GbdJSKKVz_VE-PZ1ZFa1iA";
  ...
  var countBrnDrn = 0,
    brndrnvalue = "";
  if (
    requestdata.brn_value != null &&
    requestdata.brn_value != undefined &&
    requestdata.brn_value != "" &&
    requestdata.drn_value != null &&
    requestdata.drn_value != undefined &&
    requestdata.drn_value != ""
  ) {
    countBrnDrn++;
  } else if (
    requestdata.brn_value != null &&
    ...
    return new Promise((resolve, reject) => {
      ...
      axios(config_url).then(async (response) => {
        ...
        if (response == null || response == undefined) {
          ...
          console.log(
            "response for brn: " + JSON.stringify(response.data.data)
          );
        }
        ...
        if (
          secondrespose != null &&
          secondrespose != "" &&
          secondrespose != undefined &&
          secondrespose != undefined &&
          secondrespose.data != undefined &&
          secondrespose.data != [] &&
          secondrespose.data != ""
        ) {
